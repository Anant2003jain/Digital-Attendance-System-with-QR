...
# Load label mapping
label_dict = {}
with open('StudentData//class.csv', mode='r') as csvfile:
...
train_data = []
labels = []
for folder_name in os.listdir('StudentData//images'):
        folder_path = os.path.join('StudentData//images', folder_name)
...
def mark_attendance():
    ...
    if os.path.exists('StudentData//attendancelist.csv'):
        attendance_df = pd.read_csv('StudentData//attendancelist.csv', index_col='nameID')
    else:
