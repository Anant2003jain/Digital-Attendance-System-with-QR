try:
    ...
    while True:
        ...
        if choice == '1':
            ...
            from StudentRegister import register_user
            register_user()
            
        elif choice == '2':
            print("Loading...")
            print("Please Wait for a while")
            from G7Model import G7model_Train
            G7model_Train()
            ...
            print("Loading...")
            print("Please Wait for a while")
            from Face_Prediction import G7_prediction
            G7_prediction()
            ...
            print("Loading...")
            print("Please Wait for a while")
            from markAttendance import attendance_chart
            attendance_chart()
            
        elif choice == '6':
            print("Loading...")
            print("Please Wait for a while")
            from markAttendance import show_student_chart
            show_student_chart()
            
        elif choice == '7':
            print("Loading...")
            print("Please Wait for a while")
            from RemoveData import remove_user
            remove_user()
